...
module.exports = {
    ...
    async execute(sock, msg, args) {
        ...
        if (petPenantang.kondisi !== 'Sehat') return await sock.sendMessage(chatId, { text: `⚠️ Pet kamu sedang ${petPenantang.kondisi}. Obati dulu sebelum duel!` }, { quoted: msg });
        if (petTarget.kondisi !== 'Sehat') return await sock.sendMessage(chatId, { text: `⚠️ Pet lawan sedang sakit dan tidak bisa diajak berduel.` }, { quoted: msg });
